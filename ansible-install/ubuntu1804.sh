...
&& echo "deb http://ppa.launchpad.net/ansible/ansible/ubuntu bionic main" | tee "${source_list_path}" \
&& echo "deb-src http://ppa.launchpad.net/ansible/ansible/ubuntu bionic main" | tee -a "${source_list_path}" \
&& apt-get update \
